...
class ExamAIServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.pre_summary = channel.unary_unary(
                ...
                response_deserializer=protos_dot_examgen__pb2.GenerateSummaryResponse.FromString,
                _registered_method=True)
...
def add_ExamAIServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'pre_summary': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_examgen__pb2.GenerateSummaryRequest.FromString,
                    response_serializer=protos_dot_examgen__pb2.GenerateSummaryResponse.SerializeToString,
            ),
    }
...
class ExamAIService:
    ...
    def pre_summary(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ExamAIService/pre_summary',
            protos_dot_examgen__pb2.GenerateSummaryRequest.SerializeToString,
            protos_dot_examgen__pb2.GenerateSummaryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
